...
class basicfunctions:
    ...
    def quit_program():
        ...
        errorhandling.basicfunctions.clear_screen()
        print("goodbye")
        sys.exit()  
        ...
        while True:  # loop for navigating back
            ...
            match user_input:
                ...
                case 'Q' | 'q':  # quit program
                    basicfunctions.quit_program()
                
                case '1':  # calculate the momentum
                    basicfunctions.clear_screen()
                    try:  # Try to convert user input to numbers
                        mass = abs(float(basicfunctions.compact_signs(log_user_input("What is your mass (kg)? "))))
                        velocity = float(basicfunctions.compact_signs(log_user_input("What is your velocity (m/s)? ")))
                        momentum = mass * velocity
                        
                        log_result(momentum)

                        if math.isinf(momentum):
                            errorhandling.invalid_input_infinityerror()
                        else:
                            print('Your momentum is: ', momentum, 'N')
                        
                    except ValueError:  # Handle invalid input
                        errorhandling.invalid_input_valueerror()
                    except Exception as e:
                        errorhandling.invalid_input_notrecognized()
                        
                case '2':  # calculate the Mass
                    basicfunctions.clear_screen()
                    try:
                        momentum = float(basicfunctions.compact_signs(log_user_input("What is your momentum (N)? ")))
                        velocity = float(basicfunctions.compact_signs(log_user_input("What is your velocity (m/s)? ")))
                        
                        if velocity == 0:
                            errorhandling.invalid_input_zerodivisionerror()
                            continue
        ...
        while True:  # loop for navigating back
            ...
            match user_input:
                ...
                case '1':  # calculate mass
                    basicfunctions.clear_screen()
                    try:  # Try to convert user input to numbers
                        force = float(basicfunctions.compact_signs(log_user_input('What is your force (N)? ')))
                        acceleration = float(basicfunctions.compact_signs(log_user_input('What is your acceleration (m/s^2)? ')))
        ...
        while True:  # loop for navigating back
            ...
            match user_input:
                ...
                case '1':  # calculate if the two forces are equal
                    basicfunctions.clear_screen()
                    try:  # Try to convert user input to numbers
                        m1 = abs(float(basicfunctions.compact_signs(log_user_input('input mass 1 (kg): '))))
                        a1 = float(basicfunctions.compact_signs(log_user_input('input acceleration 1 (m/s^2): ')))
                        m2 = abs(float(basicfunctions.compact_signs(log_user_input('input mass 2 (kg): '))))
                        a2 = float(basicfunctions.compact_signs(log_user_input('input acceleration 2 (m/s^2): ')))
        ...
        while True:  # loop for navigating back
            ...
            match user_input:
                ...
                case '1':
                    basicfunctions.clear_screen()
                    try:
                        x0 = float(basicfunctions.compact_signs(log_user_input('input starting distance (m): '))) 
                        v0 = float(basicfunctions.compact_signs(log_user_input('input starting velocity (m/s): ')))  
                        a = float(basicfunctions.compact_signs(log_user_input('input acceleration (m/s^2): ')))
                        t = abs(float(basicfunctions.compact_signs(log_user_input('input time (s): '))))
                ...
                case '2':
                    ...
                    try:
                        v0 = float(basicfunctions.compact_signs(log_user_input('input starting velocity (m/s): ')))
                        a = float(basicfunctions.compact_signs(log_user_input('input starting acceleration (m/s^2): ')))
                        t = abs(float(basicfunctions.compact_signs(log_user_input('input time (s): '))))
                ...
                case '3':
                    basicfunctions.clear_screen()
                    try:
                        v = float(basicfunctions.compact_signs(log_user_input('input velocity (m/s): ')))
                        v0 = float(basicfunctions.compact_signs(log_user_input('input starting velocity (m/s): ')))
                        t = abs(float(basicfunctions.compact_signs(log_user_input('input time (s): '))))
        ...
        while True:  # loop for navigating back
            ...
            match user_input:
                ...
                case '1':
                    basicfunctions.clear_screen()
                    try:
                        mass = abs(float(basicfunctions.compact_signs(log_user_input('input mass (kg): '))))
                        g_constant = float(basicfunctions.compact_signs(log_user_input('input gravitational constant (m/s^2): ')))
                ...
                case '2':
                    ...
                    try:
                        g_constant = float(basicfunctions.compact_signs(log_user_input('input gravitational constant (m/s^2): ')))
                        f_g = float(basicfunctions.compact_signs(log_user_input('input force of gravity (N): ')))
        ...
        while True:  # loop for navigating back
            ...
            match user_input:
                ...
                case '1':
                    basicfunctions.clear_screen()
                    try:
                        c_w = float(basicfunctions.compact_signs(log_user_input('input air resistance coefficient: ')))
                        density = float(basicfunctions.compact_signs(log_user_input('input air density (kg/m^3): ')))
                        surface_area = float(basicfunctions.compact_signs(log_user_input('input surface area (m^2): ')))
                        velocity = float(basicfunctions.compact_signs(log_user_input('input velocity (m/s): ')))
                ...
                case '2':
                    ...
                    try:
                        ...
                        surface_area = float(basicfunctions.compact_signs(log_user_input('input surface area (m^2): ')))
                        velocity = float(basicfunctions.compact_signs(log_user_input('input velocity (m/s): ')))
                        f_air = float(basicfunctions.compact_signs(log_user_input('input air resistance (N): ')))
                ...
                case '5':
                    ...
                    try:
                        ...
                        if (2 * f_air) / (density * c_w * surface_area) <= 0:
                            errorhandling.invalid_input_rooterror()
                            continue
        ...
        while True:  # loop for navigating back
            ...
            match user_input:
                ...
                case '1':
                    basicfunctions.clear_screen()
                    try:
                        normal_force = float(basicfunctions.compact_signs(log_user_input('input normal force (N): ')))
                        c_s_friction = float(basicfunctions.compact_signs(log_user_input('input static friction coefficient: ')))
                ...
                case '2':
                    ...
                    try:
                        c_s_friction = float(basicfunctions.compact_signs(log_user_input('input static friction coefficient: ')))
                        s_friction = float(basicfunctions.compact_signs(log_user_input('input static friction (N): ')))
        ...
        while True:  # loop for navigating back
            ...
            match user_input:
                ...
                case '1':
                    ...
                    try:
                        normal_force = float(basicfunctions.compact_signs(log_user_input('input normal force (N): ')))
                        c_d_friction = float(basicfunctions.compact_signs(log_user_input('input dynamic friction coefficient: ')))
                ...
                case '2':
                    ...
                    try:
                        c_d_friction = float(basicfunctions.compact_signs(log_user_input('input dynamic friction coefficient: ')))
                        d_friction = float(basicfunctions.compact_signs(log_user_input('input dynamic friction (N): ')))
        ...
        while True:  # loop for navigating back
            ...
            match user_input:
                ...
                case '1':
                    basicfunctions.clear_screen()
                    try:
                        spring_c = float(basicfunctions.compact_signs(log_user_input('input spring constant (N/m): ')))
                        stretch = float(basicfunctions.compact_signs(log_user_input('input stretch (m): ')))
                ...
                case '2':
                    ...
                    try:
                        stretch = float(basicfunctions.compact_signs(log_user_input('input stretch (m): ')))
                        force_spring = float(basicfunctions.compact_signs(log_user_input('input spring force (N): ')))
        ...
        while True:  # loop for navigating back
            ...
            match user_input:
                ...
                case '1':
                    ...
                    try:
                        mass = abs(float(basicfunctions.compact_signs(log_user_input('input mass (kg): '))))
                        velocity = float(basicfunctions.compact_signs(log_user_input('input stretch (m): ')))
                        radius = float(basicfunctions.compact_signs(log_user_input('input radius (m): ')))
                ...
                case '2':
                    ...
                    try:
                        velocity = float(basicfunctions.compact_signs(log_user_input('input stretch (m): ')))
                        radius = float(basicfunctions.compact_signs(log_user_input('input radius (m): ')))
                        f_mpz = abs(float(basicfunctions.compact_signs(log_user_input('input centripedal force (N): '))))
        ...
        while True:  # loop for navigating back
            ...
            match user_input:
                ...
                case '1':
                    ...
                    try:
                        mass = abs(float(basicfunctions.compact_signs(log_user_input('input mass (kg): '))))
                        gravitational_acceleration = float(basicfunctions.compact_signs(log_user_input('input gravitational acceleration (m/s^2): ')))
                        height = float(basicfunctions.compact_signs(log_user_input('input height (m): ')))
                ...
                case '2':
                    basicfunctions.clear_screen()
                    try:
                        gravitational_energy = float(basicfunctions.compact_signs(log_user_input('input gravitational potential energy (J): ')))
                        gravitational_acceleration = float(basicfunctions.compact_signs(log_user_input('input gravitational acceleration (m/s^2): ')))
                        height = float(basicfunctions.compact_signs(log_user_input('input height (m): ')))
        ...
        while True:  # loop for navigating back
            ...
            match user_input:
                ...
                case '2':
                    ...
                    try:
                        velocity = float(basicfunctions.compact_signs(log_user_input('input velocity (m/s): ')))
                        kinetic_energy = float(basicfunctions.compact_signs(log_user_input('input kinetic energy (J): ')))
        ...
        while True:  # loop for navigating back
            ...
            match user_input:
                ...
                case '1':
                    basicfunctions.clear_screen()
                    try:
                        moment_of_inertia = float(basicfunctions.compact_signs(log_user_input('input moment of inertia (kgm^2): ')))
                        angular_velocity = float(basicfunctions.compact_signs(log_user_input('input angular velocity (rad/s): ')))
                ...
                case '2':
                    ...
                    try:
                        angular_velocity = float(basicfunctions.compact_signs(log_user_input('input angular velocity (rad/s): ')))
                        kinetic_energy_rotation = float(basicfunctions.compact_signs(log_user_input('input kinetic energy of rotation (J): ')))
        ...
        while True:  # loop for navigating back
            ...
            match user_input:
                ...
                case '2':
                    ...
                    try:
                        velocity = float(basicfunctions.compact_signs(log_user_input('input velocity (m/s): ')))
                        momentum_result = float(basicfunctions.compact_signs(log_user_input('input momentum (kgm/s): ')))
        ...
        while True:  # loop for navigating back
            ...
            match user_input:
                ...
                case '1':
                    basicfunctions.clear_screen()
                    try:
                        force = float(basicfunctions.compact_signs(log_user_input('input force (N): ')))
                        radius = float(basicfunctions.compact_signs(log_user_input('input radius (m): ')))
                ...
                case '2':
                    ...
                    try:
                        radius = float(basicfunctions.compact_signs(log_user_input('input radius (m): ')))
                        impulse = float(basicfunctions.compact_signs(log_user_input('input impulse (Nm): ')))
        ...
        while True:  # loop for navigating back
            ...
            match user_input:
                ...
                case '1':
                    basicfunctions.clear_screen()
                    try:
                        alpha = float(basicfunctions.compact_signs(log_user_input('input linear expansion coefficient (C^-1): ')))
                        initial_length = float(basicfunctions.compact_signs(log_user_input('input initial length (m): ')))
                        delta_temperature = float(basicfunctions.compact_signs(log_user_input('input change in temperature (delta T): ')))
                ...
                case '2':
                    ...
                    try:
                        initial_length = float(basicfunctions.compact_signs(log_user_input('input initial length (m): ')))
                        delta_length = float(basicfunctions.compact_signs(log_user_input('input change in length (delta m): ')))
                        delta_temperature = float(basicfunctions.compact_signs(log_user_input('input change in temperature (delta T): ')))
        ...
        while True:  # loop for navigating back
            ...
            match user_input:
                ...
                case '1':
                    ...
                    try:
                        alpha = float(basicfunctions.compact_signs(log_user_input('input linear expansion coefficient (C^-1): ')))
                        initial_area = float(basicfunctions.compact_signs(log_user_input('input initial area (m^2): ')))
                        delta_temperature = float(basicfunctions.compact_signs(log_user_input('input change in temperature (delta T): ')))
                ...
                case '2':
                    ...
                    try:
                        initial_area = float(basicfunctions.compact_signs(log_user_input('input initial area (m^2): ')))
                        delta_area = float(basicfunctions.compact_signs(log_user_input('input change in area (delta m^2): ')))
                        delta_temperature = float(basicfunctions.compact_signs(log_user_input('input change in temperature (delta T): ')))
        ...
        while True:  # loop for navigating back
            ...
            match user_input:
                ...
                case '1':
                    basicfunctions.clear_screen()
                    try:
                        alpha = float(basicfunctions.compact_signs(log_user_input('input volumetric expansion coefficient (C^-1): ')))
                        initial_volume = float(basicfunctions.compact_signs(log_user_input('input initial volume (m^3): ')))
                        delta_temperature = float(basicfunctions.compact_signs(log_user_input('input change in temperature (delta T): ')))
                        ...
                        errorhandling.invalid_input_exceptionerror
                case '2':
                    basicfunctions.clear_screen()
                    try:
                        initial_volume = float(basicfunctions.compact_signs(log_user_input('input initial volume (m^3): ')))
                        delta_volume = float(basicfunctions.compact_signs(log_user_input('input change in volume (delta m^3): ')))
                        delta_temperature = float(basicfunctions.compact_signs(log_user_input('input change in temperature (delta T): ')))
        ...
        while True:  # loop for navigating back
            ...
            match user_input:
                ...
                case '1':
                    basicfunctions.clear_screen()
                    try:
                        pressure = float(basicfunctions.compact_signs(log_user_input('input pressure (Pa): ')))
                        delta_volume = float(basicfunctions.compact_signs(log_user_input('input change in volume (delta v): ')))
                ...
                case '2':
                    basicfunctions.clear_screen()
                    try:
                        work = float(basicfunctions.compact_signs(log_user_input('input work (J): ')))
                        delta_volume = float(basicfunctions.compact_signs(log_user_input('input change in volume (delta v): ')))
        ...
        while True:  # loop for navigating back
            ...
            match user_input:
                ...
                case '1':
                    basicfunctions.clear_screen()
                    try:
                        n = float(basicfunctions.compact_signs(log_user_input('input number of moles (mol): ')))
                        gas_constant = float(basicfunctions.compact_signs(log_user_input('input gas constant (C^-1): ')))
                        temperature = float(basicfunctions.compact_signs(log_user_input('input temperature (K): ')))
                        volume_ratio = float(basicfunctions.compact_signs(log_user_input('input volume ratio (volume2/volume1): ')))

                        if volume_ratio <= 0:
                            errorhandling.invalid_input_logarithmerror() 
                            continue
                ...
                case '2':
                    basicfunctions.clear_screen()
                    try:
                        work = float(basicfunctions.compact_signs(log_user_input('input work done (J): ')))
                        gas_constant = float(basicfunctions.compact_signs(log_user_input('input gas constant (C^-1): ')))
                        temperature = float(basicfunctions.compact_signs(log_user_input('input temperature (K): ')))
                        volume_ratio = float(basicfunctions.compact_signs(log_user_input('input volume ratio (volume2/volume1): ')))
        ...
        while True:  # Loop for navigating back
            ...
            match user_input:
                ...
                case '1':
                    basicfunctions.clear_screen()
                    try:
                        q = float(basicfunctions.compact_signs(log_user_input('Input heat added (J): ')))
                        w = float(basicfunctions.compact_signs(log_user_input('Input work done (J): ')))
                ...
                case '2':
                    ...
                    try:
                        w = float(basicfunctions.compact_signs(log_user_input('Input work done (J): ')))
                        delta_e_int = float(basicfunctions.compact_signs(log_user_input('Input internal energy (J): ')))
